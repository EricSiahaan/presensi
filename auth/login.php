...
if (isset($_POST["login"])) {
    ...
    $result = mysqli_query($connection, "SELECT * FROM users JOIN pegawai ON users.
    id_pegawai = pegawai.id WHERE username = '$username'");
                            ...
                            <div class="card-body">
                                ...
                                <form action="" method="post" autocomplete="off" novalidate>
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="username" autofocus placeholder="username" autocomplete="off">
                                    </div>
                                    <div class="mb-2">
