    ...
    <div class="container-xl">
        ...
        <tr class=" text-center">
            ...
            <?php if (mysqli_num_rows($result) ===  0) { ?>
                <tr>
                    <td colspan="6">Data Kosong, Silahkan masukan data Baru</td>
                </tr>
            <?php } else { ?>
                <?php $no = 1;
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="<?= base_url('admin/data_lokasi_presensi/detail.php?id=' . $lokasi['id']) ?>" class="badge badge-pill bg-success">Detail</a>
